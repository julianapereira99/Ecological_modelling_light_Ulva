...
inputs.pathd.short_name='Medium_Light_sP_y_cP';              % To identify figures and reports for a given problem 
...
inputs.PEsol.global_theta_min=[0    0   -4   1.2    4.82   0    0   0    0   ] ;
inputs.PEsol.global_theta_max=[2    50    10  3.5    10     50    5   5   10] ;

% inputs.PEsol.global_theta_min=[0    0    -4  1.2    4.82  0  -20   0   2    ] ;
% inputs.PEsol.global_theta_max=[2    30    10   4    10   20  0   5   10.02] ;

%Primera hipótesis - r1

% inputs.PEsol.global_theta_guess(1)=3.0925e-01;      
% inputs.PEsol.global_theta_guess(2)=5.6284;
% inputs.PEsol.global_theta_guess(3)=-5.0969e-06 ;        
% inputs.PEsol.global_theta_guess(4)=2.0592;          
% inputs.PEsol.global_theta_guess(5)=5.9927;
