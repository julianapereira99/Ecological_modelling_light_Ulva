...
inputs.pathd.short_name='High_Light_sP_y_cP';              % To identify figures and reports for a given problem 
...
inputs.PEsol.global_theta_min=[0    0      0   1.2    4.82   0    0   0    0   ] ;
inputs.PEsol.global_theta_max=[2    100    10  3.5    10     1    5   1   10] ;
% inputs.PEsol.global_theta_min=[0    10   -4  1.2    4.82    0    0   0    2   ] ;
% inputs.PEsol.global_theta_max=[2    30    1   3.5    10     1e-5    5   1   10] ;


%Primera hipótesis - r2


% inputs.PEsol.global_theta_guess(1)=1.5636e-01;      
% inputs.PEsol.global_theta_guess(2)=4.6174e+01;
% inputs.PEsol.global_theta_guess(3)=8.5388e-06;        
% inputs.PEsol.global_theta_guess(4)=6.8656;          
% inputs.PEsol.global_theta_guess(5)=6.0223;
% inputs.PEsol.global_theta_guess(6)=9.0155e-02;          
