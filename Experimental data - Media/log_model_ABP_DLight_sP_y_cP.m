...
inputs.pathd.short_name='Dark_Light_sP_y_cP';              % To identify figures and reports for a given problem 
...
inputs.PEsol.global_theta_min=[0    0   -4   1.2    4.82   -5    -5   0    0   ] ;
inputs.PEsol.global_theta_max=[2    30    10  3.5    10     5    5   5   10] ;

% inputs.PEsol.global_theta_min=[0    1    -4    3    4.82   0  -20   0   2    ] ;
% inputs.PEsol.global_theta_max=[0.5  30    0.1   3.5   10   1   10   1   10.02] ;

%Primera hipótesis - r1

inputs.PEsol.global_theta_guess(1)=1.8209e-01;      
inputs.PEsol.global_theta_guess(2)=2.1230e+01;
inputs.PEsol.global_theta_guess(3)=7.7708e-06 ;        
inputs.PEsol.global_theta_guess(4)=5.6098;          
inputs.PEsol.global_theta_guess(5)=5.9398;
inputs.PEsol.global_theta_guess(6)= 5.9805;          
