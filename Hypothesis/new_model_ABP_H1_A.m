...
%==================================
 ...
 inputs.PEsol.id_global_theta=char('KA','aAB','aBA','aBP','aPA','aPB' ); 


                            
inputs.PEsol.global_theta_min=[ 6     -1e-4    -1e-8 -1e-8 -1e-8 -1e-8    ] ;
inputs.PEsol.global_theta_max=[ 8.25  1e-8    1e-8   1e-8    1e-8 1e-7   ] ;
...
%Note that algae do not grow in darkness therefore mu=0 
    ...
    inputs.PEsol.local_theta_max{4}=[ 1e-5]; 
